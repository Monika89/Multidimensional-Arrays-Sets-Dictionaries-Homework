...
class MaximalSum
{
    static void Main()
    {
        ...
        int inputRows = int.Parse(inputRowsAndColumns[0]);
        int inputColumns = int.Parse(inputRowsAndColumns[1]);
        int[,] matrix = new int[inputRows + 1, inputColumns + 1];
        ...
        for (int row = 0; row < inputRows - 2; row++)
        {
            for (int col = 0; col < inputColumns - 2; col++)
            {
